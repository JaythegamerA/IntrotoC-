...
namespace CRPG
{
    public static class World
    {
        ...
        public static readonly string FirstWorldName = "the E.A. Earth";
        ...
        public const int ITEM_ID_MEDALLION = 11;
        ...
        public const int LOCATION_ID_TEMPLE = 10;
        public const int LOCATION_ID_FOREST_CLEARING = 11;
        public const int LOCATION_ID_VILLAGE = 12;
        ...
        {
            Items.Add(new Item (ITEM_ID_MEDALLION, "Magic Medallion", "Magic Medallion"));
            ...
            Items.Add(new Healing(ITEM_ID_HEALING_POTION, "Healing potion", "Healing potions", 5));
        ...
        private static void PopulateLocations()
        {
            ...
            Location home = new Location(LOCATION_ID_HOME, "\"Home\"", "Someone's house. It's rather messy, but it doesnt matter. You dont live here.");

            Location townSquare = new Location(LOCATION_ID_TOWN_SQUARE, "Town square", "You see a fountain. It reminds you of your own town, which makes you tense up.");

            Location alchemistHut = new Location(LOCATION_ID_ALCHEMIST_HUT, "Alchemist's hut", "There are many strange plants on the shelves. They look nothing like the ones in your world.");
            alchemistHut.QuestAvailableHere = QuestByID(QUEST_ID_CLEAR_ALCHEMIST_GARDEN);

            Location alchemistsGarden = new Location(LOCATION_ID_ALCHEMISTS_GARDEN, "Alchemist's garden", "Many foreign plants are growing here.");
            ...
            forestClearing.LocationTP = home;
