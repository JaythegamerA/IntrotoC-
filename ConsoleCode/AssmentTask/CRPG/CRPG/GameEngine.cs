...
namespace CRPG
{
    public static class GameEngine
    {
        ...
        public static void Initialize(int world)
        {
            Console.WriteLine($"Initializing Game Engine v{Version}");
            Console.WriteLine((world == 1) ? $"Welcome to {World.WorldName}" : $"Welcome to {World.FirstWorldName}");
            Console.WriteLine();
            //World.ListLocations();
            //World.ListItems();
            //World.ListMonsters();
        ...
        public static void MonsterProcessor(Player _player, Location newLocation)
        {
            ...
            {
                monsterMessage += $"You see a strange creature... The locals refer to it as a \"{newLocation.MonsterLivingHere.Name}\"";
